...
public class AdocaoService {
    ...
    public void solicitar(SolicitacaoDeAdocaoDTO dto){
        ...
        if(pet.getAdotado()){
            // Unchecked exception -> São exceções que o compilador não obriga a tratar.
            throw new AdocaoException("Pet já adotado."); // Lança uma exceção do tipo AdocaoException com a mensagem "Pet já adotado."
        }
        ...
        if(petAdocaoEmAndamento){
            // Unchecked exception -> São exceções que o compilador não obriga a tratar.
            throw new AdocaoException("Pet com adoção em andamento."); // Lança uma exceção do tipo AdocaoException com a mensagem "Pet com adoção em andamento."
        }
        ...
        if(tutorAdocoes == 2){
            // Unchecked exception -> São exceções que o compilador não obriga a tratar.
            throw new AdocaoException("Tutor já possui 2 adoções aprovadas."); // Lança uma exceção do tipo AdocaoException com a mensagem "Tutor já possui 2 adoções aprovadas."
        }
