...
public class ImageStorageService {
    ...
    // O throws IOException é uma forma de dizer que o método pode lançar uma exceção do tipo IOException.
    public String upload(MultipartFile imagem) throws IOException {
        ...
        // Checked exception -> São exceções que o compilador obriga a tratar.
